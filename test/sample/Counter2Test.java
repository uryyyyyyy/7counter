...
public class Counter2Test {
	...
	public void test6() {
		...
		assertThat(Integer.valueOf(counter.count(23678947, 7)), is(16140633));
		assertThat(Integer.valueOf(counter.count(732465890, 7)), is(614891670));
		assertThat(Integer.valueOf(counter.count(1912478368, 7)), is(7*4000 + 4*300 + 7*20 + 0*1 + 4709 + 9 + 1));
	}
